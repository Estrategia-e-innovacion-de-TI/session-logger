...
SESSION_LOGGER_OTLP_CLIENT_CERT="${COPILOT_SESSION_LOGGER_OTLP_CLIENT_CERT:-}"
SESSION_LOGGER_OTLP_CLIENT_KEY="${COPILOT_SESSION_LOGGER_OTLP_CLIENT_KEY:-}"
SESSION_LOGGER_OTLP_CA_CERT="${COPILOT_SESSION_LOGGER_OTLP_CA_CERT:-}"
